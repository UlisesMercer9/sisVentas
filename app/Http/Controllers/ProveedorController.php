...
class ProveedorController extends Controller
{
    ...
    public function index(Request $request)
   {
        ...
        return view('proveedores.index',["personas"=>$personas,'searchText'=>$query]);
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('message','Haz agreado un nuevo proveedor satisfactoriamente');
    ...
    public function edit($id)
    {
        ...
        return view('proveedores.edit',['persona' => $persona]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('message','Haz actualizado los datos del proveedor satisfactoriamente');
        return redirect::to('/proveedores');
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash('message','Haz eliminado los datos del proveedor satisfactoriamente');
        return redirect::to('/proveedores');
    }
