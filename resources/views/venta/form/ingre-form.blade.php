 ...
 <label for="cliente_id" class="input-field col s12 l5 blue-grey-text"> Proveedor
        
        {!!Form::select('cliente_id',$personas,null,['class'=>'browser-default col s12 offset-s1 l12 offset-l2','placeholder'=>'Elija un cliente','id'=>'cliente_id','data-error'=>'.errorTxt1'])!!} 
...
<div class="input-field col s12 l5 offset-l1">
         ...
         {!! Form::select('tipo_comprobante', ['Boleta' => 'Boleta', 'Factura' => 'Factura','Ticket' => 'Ticket'],null,['class' => 'browser-default col s10 offset-s2 l12 offset-l2', 'placeholder' => 'Elija un tipo de comprobante','data-error'=>'.errorTxt2']) !!}
