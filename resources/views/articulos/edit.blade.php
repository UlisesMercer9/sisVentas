...
<div class="row container">
  ...
  <nav class="col s12 m12 l6 #ffffff white no-border">
    <div class="nav-wrapper #01579b light-blue darken-4  z-depth-2">
      <div class="col s12">
        <a href="{!!URL::to('/articulos')!!}" class="breadcrumb">&nbsp; Inicio</a>
        <a href="#!" class="breadcrumb">Actualizar artículos</a>
   ...
   <br><br>
    ...
    <!--Inicio del formulario para crear administrador-->
          <div class="col s12">
            ...
            {!!Form::model($articulo,['route'=>['articulos.update',$articulo->id],'method'=>'PUT','name'=>'ArtUpdateForm','id'=>'ArtUpdateForm'])!!}
                ...
                <div class="card-stacked">
                   <div class="row">
                      <div class="card-content">
                          @include('articulos.form.art-form')
                      </div>
                      <br><br>
